...
namespace Core.TypeCast
{
    ...
    public enum ConverterCause : ulong
    {
        ...
        /// <summary>
        /// Indicates that the reflection of the loading assembly failed during loading one of the containing class methods to the ConverterCollection.
        /// </summary>
        [Description("Indicates that the reflection of the loading assembly failed during loading one of the containing class methods to the ConverterCollection.")]
        ConverterInitializationFailed = 1 << 17,
        ...
        ConverterAutoInitializationFailed = 1 << 18,
        ...
        TransformRequiresEqualInOutTypes = 1 << 19,
        ...
        DelegateArgumentWrongType = 1 << 21,
