...
namespace Core.TypeCast
{
    ...
    /// </summary>
    public enum ConverterCollectionCause
    {
        /// <summary>
        ...
        ConverterArgumentWrongType = 1 << 7, 
        ...
        InstanceRequiresParameters = 1 << 9,
