...
namespace Core.TypeCast
{
    ...
    public static partial class ObjectExtension
    {
        ...
        /// <remarks>Use <see cref="TryConvertonvert{TOut}" /> instead if you do not want to raise any <see cref="ConverterException" /> 
        ...
        /// </example>
        /// <exception cref="ConverterException">Throws an exception of type <see cref="ConverterException" />if the conversion fails</exception>
        /// <remarks>Use <see cref="TryConvert{TIn,TOut}" /> instead if you do not want to raise <see cref="ConverterException" />
        /// </remarks>
        /// <remarks>note: The <see cref="ConverterCollection"/> is lazy instantiated upon the first invocation of the method</remarks>
        ...
        /// <summary>The cast method following the `Try` function convention of the .Net Framework, returning a <see cref="bool"/> success 
